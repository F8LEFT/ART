...
namespace KTextEditor {
    enum DocumentPrivate {EncodeAlways, EncodeWhenPresent, EncodeNever};
}
...
public:
    ...
    */
    ...
    void getKateExtendedAttributeList(const QString &schema, QList<KTextEditor::Attribute::Ptr> &);
    void getKateExtendedAttributeListCopy(const QString &schema, QList<KTextEditor::Attribute::Ptr> &);
