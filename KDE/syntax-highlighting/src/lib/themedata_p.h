...
public:
    ...
    /**
     * Parse Theme data to the json format.
     */
    ...
    void setTextColor(Theme::TextStyle style, QRgb rgb);
    ...
    void setSelectedTextColor(Theme::TextStyle style, QRgb rgb);
    ...
    void setBackgroundColor(Theme::TextStyle style, QRgb rgb);
...
public:
    ...
    void setEditorColor(Theme::EditorColorRole role, QRgb rgb);
