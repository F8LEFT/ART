...
public:
    ...
    */
    ...
    void setTextColor(TextStyle style, QRgb rgb) const;
    ...
    void setSelectedTextColor(TextStyle style, QRgb rgb) const;
    ...
    void setBackgroundColor(TextStyle style, QRgb rgb) const;
...
public:
    ...
    void setEditorColor(EditorColorRole role, QRgb rgb) const;

    /**
     * Returns the theme config in json format.
     */
    QByteArray getThemeConfig();
